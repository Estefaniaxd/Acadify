...
export default function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!acceptedTerms) {
      alert("Debes aceptar la política de privacidad y el tratamiento de datos personales.");
      return;
    }
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2 bg-gray-50 p-3 rounded-xl border">
            <p className="text-sm text-gray-700">
              ...
              <a href="/politica-privacidad" target="_blank" className="text-indigo-700 underline">
                Política de Privacidad
              </a>{" "}
              y nuestros{" "}
              <a href="/terminos-condiciones" target="_blank" className="text-indigo-700 underline">

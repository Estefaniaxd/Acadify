"""
Script para verificar columnas de racha_usuario en BD vs modelo
"""
import asyncio
import asyncpg
...
async def check_racha_usuario():
    """Compara columnas de RachaUsuario modelo vs BD"""
    ...
    try:
        ...
        bd_columns = await conn.fetch("""
            ...
            WHERE table_name = 'racha_usuario'
            ORDER BY ordinal_position
        """)
        
        print("📦 COLUMNAS EN BASE DE DATOS (racha_usuario):")
        ...
        mapper = inspect(RachaUsuario)
        model_columns = {col.key for col in mapper.columns}
        
        print(f"\n🔧 COLUMNAS EN MODELO (RachaUsuario):")
...
if __name__ == "__main__":
    asyncio.run(check_racha_usuario())

...
class Comentario(Base):
    ...
    # Contenido
    contenido = Column(Text, nullable=False, doc="Contenido del comentario")
    ...
    archivos_adjuntos = Column(
        Text, nullable=True, doc="JSON con lista de archivos adjuntos"  # JSON string
    )
    ...
    autor = relationship(
        "Usuario", back_populates="comentarios", doc="Usuario autor del comentario"
    )
    ...
    reacciones = relationship(
        ...
        doc="Reacciones a este comentario",
    )
    ...
    def archivos_lista(self, archivos: list) -> None:

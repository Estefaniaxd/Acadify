...
from sqlalchemy.dialects.postgresql import JSON, TEXT, TIMESTAMP, UUID
...
class Mensaje(Base):
    ...
    metadatos_archivos = Column(
        JSON, nullable=True
    )  # Metadatos de archivos (tamaño, tipo, etc)

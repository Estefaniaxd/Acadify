...
from sqlalchemy.dialects.postgresql import UUID, ENUM, BOOLEAN, TIMESTAMP, ARRAY, JSONB
...
class Institucion(Base):
    ...
    redes_sociales = Column(JSONB, nullable=True)  # {facebook, twitter, instagram, etc.}
    ...
    # CONFIGURACIÓN ACADÉMICA
    # ============================================
    modalidad_ensenanza = Column(String(10), nullable=False, server_default='presencial')
    ...
    # ============================================
    configuracion_regional = Column(JSONB, nullable=True)  # Zona horaria, idioma, moneda
    campos_personalizados = Column(JSONB, nullable=True)  # Campos custom por institución

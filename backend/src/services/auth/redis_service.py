...
class RedisService:
    ...
    async def store_active_refresh_token(self, user_id: str, jti: str, ttl_seconds: int):
    ...
    async def verify_and_consume_oauth_state(self, state: str) -> Optional[Dict[str, Any]]:

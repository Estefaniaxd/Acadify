...
class LocalStorageBackend(StorageBackend):
    ...
    def __init__(self, base_path: str = "static", base_url: str = "/static") -> None:
    ...
    async def save_file(self, file_content: bytes, destination_path: str) -> str:
        ...
        # 🔧 FIX: Garantizar que el directorio padre existe
...
class S3StorageBackend(StorageBackend):
    ...
    def __init__(
        ...
        self.base_url = (
            base_url or f"https://{bucket_name}.s3.{aws_region}.amazonaws.com"
        )
    ...
    async def save_file(self, file_content: bytes, destination_path: str) -> str:
        ...
        msg = "S3 upload not implemented yet"
        raise NotImplementedError(msg)

    async def delete_file(self, file_path: str) -> bool:
        # TODO: Implementar eliminación de S3
        msg = "S3 delete not implemented yet"
        raise NotImplementedError(msg)
    ...
    def file_exists(self, file_path: str) -> bool:
        ...
        msg = "S3 exists check not implemented yet"
        raise NotImplementedError(msg)
...
class StorageService:
    ...
    def _create_backend(self) -> StorageBackend:
        ...
        if storage_type == "local":
            ...
            base_url = getattr(settings, "AVATAR_ASSETS_BASE_URL", "/static").replace(
                "/assets", ""
            )
        ...
        if storage_type == "s3":
            ...
            if not bucket:
                msg = "AWS_S3_BUCKET must be set for S3 storage"
    ...
    async def save_avatar_image(
        self, image_bytes: bytes, user_id: UUID, filename: str
    ) -> str:
    ...
    async def save_preview_image(self, image_bytes: bytes, filename: str) -> str:
    ...
    async def cleanup_orphaned_files(
        self, user_id: UUID, active_filenames: list
    ) -> int:

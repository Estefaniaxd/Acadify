...
from src.schemas.auth.auth_schemas import UserCurrentResponse, UserProfileUpdate, MessageResponse
...
@router.post("", response_model=UserCurrentResponse, status_code=status.HTTP_201_CREATED)

...
async def confirm_login_security(user_id: str, request: Request) -> str:
...
async def report_suspicious_login(user_id: str, request: Request) -> str:
...
async def generic_account_action(
    action_type: str, user_id: str, request: Request
) -> str:

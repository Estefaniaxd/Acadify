...
def enviar_invitacion_coordinador(destinatario, institucion_nombre, codigo, fecha_expiracion, url_registro):
    ...
    enviar_email(destinatario=destinatario, asunto=asunto, cuerpo=html_content, html=True)

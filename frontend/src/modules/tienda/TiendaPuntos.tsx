...
import { Check, Image, Palette, Search, ShoppingBag, ShoppingCart, Smile, Sparkles, Star, TrendingUp, User, X } from 'lucide-react';
...
const categorias = [
  { id: 'todos', nombre: 'Todos', icono: ShoppingBag, color: 'from-purple-500 to-pink-500' },
  { id: 'temas', nombre: 'Temas', icono: Palette, color: 'from-blue-500 to-cyan-500' },
  { id: 'ropa', nombre: 'Avatar', icono: User, color: 'from-green-500 to-emerald-500' },
  { id: 'stickers', nombre: 'Stickers', icono: Smile, color: 'from-yellow-500 to-orange-500' },
  { id: 'fondos', nombre: 'Fondos', icono: Image, color: 'from-indigo-500 to-purple-500' }
];

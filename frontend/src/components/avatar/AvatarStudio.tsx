...
const avatarAssets = {
  ...
  hairs: [
    { id: "none", name: "Calvo", paths: [] },
    {
      id: "short",
      name: "Corto",
      paths: ["M30,35 Q60,20 90,35 Q85,45 75,50 Q60,45 45,50 Q35,45 30,35"],
    },
    {
      id: "medium",
      name: "Medio",
      paths: ["M25,30 Q60,15 95,30 Q90,55 80,65 Q60,60 40,65 Q30,55 25,30"],
    },
    {
      id: "long",
      name: "Largo",
      paths: ["M20,25 Q60,10 100,25 Q95,70 85,85 Q60,80 35,85 Q25,70 20,25"],
    },
    {
      id: "curly",
      name: "Rizado",
      paths: ["M25,30 Q45,15 65,25 Q85,15 95,30 Q90,50 80,60 Q60,55 40,60 Q30,50 25,30"],
    },
    {
      id: "ponytail",
      name: "Cola",
      paths: ["M30,35 Q60,20 90,35 Q95,40 100,45", "M25,40 Q60,25 95,40 Q90,50 85,55"],
    },
  ],
  ...
  eyes: [
    {
      id: "normal",
      name: "Normal",
      paths: ["M45,55 Q50,50 55,55 Q50,60 45,55", "M65,55 Q70,50 75,55 Q70,60 65,55"],
    },
    ...
    { id: "wink", name: "Guiño", paths: ["M45,55 L55,55", "M65,55 Q70,50 75,55 Q70,60 65,55"] },
    {
      id: "surprised",
      name: "Sorprendido",
      paths: ["M45,55 Q50,45 55,55 Q50,65 45,55", "M65,55 Q70,45 75,55 Q70,65 65,55"],
    },
  ],
  ...
  eyebrows: [
    { id: "normal", name: "Normal", paths: ["M43,48 Q50,45 57,48", "M63,48 Q70,45 77,48"] },
    {
      id: "thick",
      name: "Gruesas",
      paths: ["M43,47 Q50,44 57,47 Q50,49 43,47", "M63,47 Q70,44 77,47 Q70,49 63,47"],
    },
  ...
  accessories: [
    { id: "none", name: "Ninguno", paths: [] },
    {
      ...
      name: "Gafas",
      paths: [
        "M38,52 Q45,48 52,52 Q52,58 45,62 Q38,58 38,52",
        "M68,52 Q75,48 82,52 Q82,58 75,62 Q68,58 68,52",
        "M52,54 Q60,52 68,54",
      ],
    },
    {
    ...
    },
    {
      id: "hat",
      name: "Sombrero",
      paths: ["M25,35 Q60,20 95,35 Q100,30 105,35 Q100,25 95,20 Q60,15 25,20 Q20,25 25,35"],
    },
  ],
  ...
  clothing: [
    {
      id: "tshirt",
      name: "Camiseta",
      paths: ["M35,85 Q40,80 50,82 Q60,80 70,82 Q80,80 85,85 L85,120 L35,120 Z"],
    },
    {
      id: "hoodie",
      name: "Sudadera",
      paths: [
        "M30,85 Q35,80 45,82 Q60,80 75,82 Q85,80 90,85 L90,120 L30,120 Z",
        "M45,82 Q60,75 75,82",
      ],
    },
    {
      ...
      name: "Traje",
      paths: [
        "M35,85 Q40,80 50,82 Q60,80 70,82 Q80,80 85,85 L85,120 L35,120 Z",
        "M50,82 L50,120",
        "M45,90 Q50,88 55,90",
      ],
    },
    {
      id: "dress",
      name: "Vestido",
      paths: ["M40,85 Q50,80 60,80 Q70,80 80,85 Q85,95 90,120 L30,120 Q35,95 40,85"],
    },
  ],
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {showLayer.eyes &&
          ...
          eyes.paths.map((path, i) => (
            <path
              key={i}
              d={path}
              fill={eyes.id === "closed" || eyes.id === "wink" ? "#333" : "#fff"}
              stroke="#333"
              strokeWidth="1.5"
            />
          ))}
        ...
        {showLayer.mouth &&
          mouth &&
          mouth.paths.map((path, i) => (
            <path
              key={i}
              d={path}
              fill={mouth.id === "open" || mouth.id === "laugh" ? "#8B4513" : "none"}
              stroke="#333"
              strokeWidth="2"
              strokeLinecap="round"
            />
        ...
        {showLayer.clothing &&
          clothing &&
          clothing.paths.map((path, i) => (
            <path
              key={i}
              d={path}
              fill={i === 0 ? config.clothingColor : "#333"}
              stroke="#333"
              strokeWidth="1"
            />
          ))}
        ...
        {/* Accessories */}
        {showLayer.accessories &&
          accessories &&
          accessories.paths.map((path, i) => (
            <path
              key={i}
              d={path}
              fill={
                accessories.id === "sunglasses"
                  ? "#333"
                  : accessories.id === "glasses"
...
export default function AvatarCustomizerAdvanced() {
  ...
  const categories = [
    { id: "body", name: "Cuerpo", icon: User, color: "from-orange-500 to-red-600" },
    { id: "hair", name: "Cabello", icon: RefreshCw, color: "from-amber-500 to-orange-600" },
    { id: "face", name: "Rostro", icon: Eye, color: "from-emerald-500 to-teal-600" },
    { id: "accessories", name: "Accesorios", icon: Layers, color: "from-purple-500 to-pink-600" },
    { id: "clothing", name: "Ropa", icon: Layers, color: "from-blue-500 to-indigo-600" },
    { id: "background", name: "Fondo", icon: Sparkles, color: "from-gray-500 to-gray-700" },
  ];
  ...
  const randomizeAvatar = () => {
    const random = {
      background:
        avatarAssets.backgrounds[Math.floor(Math.random() * avatarAssets.backgrounds.length)].id,
      ...
      hairColor:
        avatarAssets.hairColors[Math.floor(Math.random() * avatarAssets.hairColors.length)],
      ...
      accessories:
        avatarAssets.accessories[Math.floor(Math.random() * avatarAssets.accessories.length)].id,
      clothing: avatarAssets.clothing[Math.floor(Math.random() * avatarAssets.clothing.length)].id,
      clothingColor:
        avatarAssets.clothingColors[Math.floor(Math.random() * avatarAssets.clothingColors.length)],
    };
              ...
              <div className="grid grid-cols-4 gap-2">
                {avatarAssets.clothingColors.map((color) => (
                  <motion.button
                    ...
                    className={`w-12 h-12 rounded-xl border-2 ${
                      currentConfig.clothingColor === color
                        ? "border-blue-500 ring-2 ring-blue-200"
                        : "border-gray-300"
                    } hover:border-blue-400 transition-all duration-200`}
                    style={{ backgroundColor: color }}
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900 dark:text-white">Avatar Studio</h1>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <div className="p-6">
                ...
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-6 rounded-2xl shadow-xl text-white mb-6">
                  ...
                  <p className="text-sm opacity-90 mb-4">
                    Crea avatares masculinos y femeninos por separado. Puedes cambiar entre ellos
                    cuando quieras.
                  </p>

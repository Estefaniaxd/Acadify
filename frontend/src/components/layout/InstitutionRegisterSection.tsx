...
import { Building2, CheckCircle, Globe, Mail, Phone, Send } from "lucide-react";
...
export default function InstitutionRegisterSection() {
  ...
  const validate = () => {
    ...
    if (!form.telefono.trim() || !/^\+?\d{7,15}$/.test(form.telefono))
      newErrors.telefono = "Teléfono válido requerido (ej: +573001234567).";
    if (form.web && !/^https?:\/\//.test(form.web))
      newErrors.web = "El sitio web debe iniciar con http:// o https://";
    return newErrors;
  };
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Únete a las instituciones educativas líderes que ya están revolucionando la educación
            con Acadify. Solicita acceso institucional y descubre el poder de la gamificación
            educativa.
          </p>
        </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Panel completo para gestionar estudiantes, cursos y métricas en tiempo real.",
              ...
              },
              {
                ...
                description:
                  "Reportes detallados sobre el progreso y engagement de tus estudiantes.",
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${benefit.color} flex items-center justify-center shadow-lg flex-shrink-0`}
                >
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 bg-white/90 dark:bg-gray-900/80 text-gray-800 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all duration-300 ${
                            errores.nombre
                      ...
                      {errores.nombre && (
                        <span className="text-red-500 text-xs mt-1 block">{errores.nombre}</span>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errores.email && (
                        <span className="text-red-500 text-xs mt-1 block">{errores.email}</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      {errores.telefono && (
                        <span className="text-red-500 text-xs mt-1 block">{errores.telefono}</span>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errores.web && (
                        <span className="text-red-500 text-xs mt-1 block">{errores.web}</span>
                      )}
                    </div>
                  </div>
                ...
                {enviado && (
                  ...
                  >
                    ...
                    <p className="text-sm">
                      Tu solicitud ha sido enviada. Nuestro equipo se pondrá en contacto contigo en

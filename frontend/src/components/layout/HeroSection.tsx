        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600">juega</span>
              <br />
              <span className="text-gray-900 dark:text-white">y </span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-teal-500 to-blue-500">potencia</span>
              <br />
            ...
            >
              Únete a la revolución educativa con nuestra plataforma gamificada. Logros, retos y una mascota que te acompaña en cada paso de tu aprendizaje.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}

...
import { ArrowRight, Calendar, Globe, Mail, Smartphone, Target, Users } from "lucide-react";
const roadmap = [
  {
    title: "Lanzamiento de la beta pública",
    date: "Q4 2025",
    description:
      "Acceso abierto a estudiantes y docentes, primeras instituciones registradas y sistema de feedback activo.",
    icon: Target,
  ...
  },
  {
    ...
    date: "Q1 2026",
    description:
      "Desafíos grupales avanzados, rankings competitivos y sistema de logros compartidos entre equipos.",
    icon: Users,
  ...
  },
  {
    ...
    date: "Q2 2026",
    description:
      "Recomendaciones personalizadas potenciadas por IA y generación automática de ejercicios adaptativos.",
    icon: Target,
  ...
  },
  {
    ...
    date: "Q3 2026",
    description:
      "Lanzamiento oficial de aplicación nativa para iOS y Android con experiencia offline.",
    icon: Smartphone,
  ...
  },
  {
    ...
    date: "Q4 2026",
    description:
      "Soporte completo multiidioma, localización cultural y alianzas estratégicas globales.",
    icon: Globe,
                ...
                >
                  ...
                  <div className={`w-full lg:w-5/12 ${isEven ? "lg:pr-12" : "lg:pl-12"}`}>
                    ...
                    >
                      ...
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-10 dark:group-hover:opacity-20 transition-opacity duration-500`}
                      />
                      {/* Badge de estado */}
                      <div
                      ...
                      <div className="relative z-10">
                        <div className="flex items-start gap-4 mb-4">
                          ...
                          <div className="flex-1">
                            <div className="text-sm font-bold text-violet-600 dark:text-violet-300 mb-1">
                              {item.date}
                            </div>
          ...
          <div className="relative p-12 rounded-3xl bg-gradient-to-br from-violet-900 via-purple-900 to-indigo-900 text-white overflow-hidden dark:bg-gradient-to-br dark:from-gray-900 dark:via-violet-950/60 dark:to-purple-900">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                y entusiastas de la tecnología educativa. ¡Únete y ayúdanos a transformar la
                educación mundial!
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 pt-8 border-t border-white/20">
                {[
                  ...
                  >
                    ...
                    <div className="text-white/80 dark:text-gray-200 font-medium">{stat.label}</div>
                  </motion.div>
                ))}
              </div>
            </div>

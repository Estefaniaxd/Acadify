...
import {
  Bell, Check, CheckCheck, Filter, Search, Trash2,
...
export default function NotificacionesPage() {
  ...
  // Hooks de datos
  const { data: notificaciones = [], isLoading, refetch } = useNotificaciones({
  ...
  const tiposNotificacion: { value: TipoNotificacion; label: string; icon: any }[] = [

...
import { AlertTriangle, BarChart, BookOpen, Calendar, CheckCircle, ChevronRight, Clock, Edit3, Eye, FileText, GraduationCap, MessageSquare, Plus, Settings, Sparkles, TrendingUp, Users } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4">
              <div className="flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                {[
                  ...
                  { key: 'analytics', label: 'Análisis', icon: BarChart }
                ].map((tab) => (
                  <button
                    key={tab.key}
          ...
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                  { label: 'Cursos Activos', value: '3', icon: BookOpen, color: 'from-emerald-500 to-teal-600' },
                  { label: 'Total Estudiantes', value: '85', icon: Users, color: 'from-blue-500 to-indigo-600' },
                  { label: 'Tareas por Revisar', value: '15', icon: FileText, color: 'from-amber-500 to-orange-600' },
                  { label: 'Promedio General', value: '82.5%', icon: TrendingUp, color: 'from-purple-500 to-pink-600' }
                ].map((stat, index) => (
                  <motion.div
                    key={index}

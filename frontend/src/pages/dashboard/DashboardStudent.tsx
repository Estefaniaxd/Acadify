...
import { Award, BookOpen, Calendar, ChevronRight, Clock, Download, FileText, MessageSquare, MoreVertical, Play, Plus, Sparkles, Star, TrendingUp, Users, Video, Zap } from 'lucide-react';
...
export default function StudentDashboard() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/50 dark:from-gray-900 dark:via-gray-900 dark:to-indigo-950/30 mt-6">
      {/* Header */}
            ...
            <div className="flex items-center space-x-4">
              <div className="flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                {[
                  ...
                  { key: 'assignments', label: 'Tareas', icon: FileText }
                ].map((tab) => (
                  <button
                    key={tab.key}
          ...
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                  { label: 'Cursos Activos', value: '4', icon: BookOpen, color: 'from-blue-500 to-indigo-600' },
                  { label: 'Tareas Pendientes', value: '3', icon: Clock, color: 'from-amber-500 to-orange-600' },
                  { label: 'Progreso Promedio', value: '79%', icon: TrendingUp, color: 'from-emerald-500 to-teal-600' },
                  { label: 'Puntos Ganados', value: '1,247', icon: Award, color: 'from-purple-500 to-pink-600' }
                ].map((stat, index) => (
                  <motion.div
                    key={index}
